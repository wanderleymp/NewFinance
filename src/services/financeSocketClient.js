...
/**
 * Cliente Socket.IO para o Finance API
...
class FinanceSocketClient {
  ...
  connectToChatNamespace() {
    if (!this.token) {
      console.error('Token não definido para conectar ao namespace de chat');
      return;
    }
...
const financeSocketClient = new FinanceSocketClient();

export default financeSocketClient;
